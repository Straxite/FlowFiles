...
hl.curve("easeOutMotion", { type = "bezier", points = { { 0, 1.2 }, { 0.6, 1 } } })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.79, bezier = "easeOutMotion", style = "popin 93%" })
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 20, bezier = "easeOutQuint", style = "fade" })

hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 1.79, bezier = "almostLinear" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1.39, bezier = "almostLinear" })

hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "easeOutMotion", style = "slidevert" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 5, bezier = "easeOutMotion", style = "slidevert" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 5, bezier = "easeOutMotion", style = "slidevert" })
