...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.1, bezier = "easeOutMotion", style = "popin 93%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.49, bezier = "linear", style = "popin 93%" })
