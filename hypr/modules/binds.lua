...
hl.bind(mainMod .. " + V", hl.dsp.submap("float"))
hl.define_submap("float", function()
...
hl.bind(ctrl .. " + UP", hl.dsp.exec_cmd("swayosd-client --output-volume raise --max-volume 150"),        { locked = true, repeating = true })
