...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("~/.config/rofi/powermenu/type-3/powermenu.sh"))
...
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("~/.config/hypr/scripts/quickshell.sh"))
...
-- hl.bind(ctrl .. " + UP", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"),        { locked = true, repeating = true })
-- hl.bind(ctrl .. " + DOWN", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"),      { locked = true, repeating = true })
hl.bind(ctrl .. " + UP", hl.dsp.exec_cmd("swayosd-client --output-volume raise --max-volume 130"),        { locked = true, repeating = true })
hl.bind(ctrl .. " + DOWN", hl.dsp.exec_cmd("swayosd-client --output-volume lower --max-volume 130"),        { locked = true, repeating = true })
