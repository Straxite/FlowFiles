...
ShellRoot {
  ...
  PanelWindow {
    ...
    // only steal keyboard focus while the launcher is actually open
    WlrLayershell.keyboardFocus: pill.showLauncher
    ...
    IpcHandler {
      ...
      function hide(): void { pill.showLauncher = true }
    }
      ...
      Rectangle {
        ...
        Connections {
          ...
          function onFocusedWorkspaceChanged() {
            if (!pill.showLauncher) revealTimer.restart()
          }
        }
