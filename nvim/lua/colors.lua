return {
    image = "/home/hannah/.config/backgrounds/Everforest/fog_forest_1.png",
    ...
    primary_fixed = "#b9eaff",

    primary_fixed_dim = "#89d0ed",
